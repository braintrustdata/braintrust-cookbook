...
A [prompt](/docs/evaluate/write-prompts) is the set of instructions sent to the model, which can be user input or variables set within your code. For example:
...
It’s time to [interpret your results](/docs/evaluate/interpret-results). Examine the comprehensiveness scores and other feedback generated by your evals.
...
- [Writing more specific evals](/docs/evaluate/run-evaluations) or learning about [different scoring functions](/docs/evaluate/run-evaluations#scorers)
- Walking through other examples of best practices for building high-quality AI products in the [Braintrust cookbook](/docs/cookbook)
- Changing how you [log data](/docs/observe/view-logs), including [incorporating user feedback](/docs/observe/view-logs#user-feedback)
