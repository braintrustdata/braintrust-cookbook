...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/column-grouping-poster.png"
>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/group-summaries-poster.png"
>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/create-column-dialog-poster.png"
>
...
<Callout type="info">
  To compute LLM metrics (like token counts), make sure you [wrap your LLM
  calls](/docs/guides/traces/customize#wrapping-llm-clients).
</Callout>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/diff-poster.png"
>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/diff-trials-poster.png"
>
...
<Image
  ...
  src="/docs/guides/projects/comparison-key.png"
  alt="Create comparison key"
  width={1552 / 2}
  height={282 / 2}
/>
...
<Image
  unoptimized
  className="box-content"
  src="/docs/guides/evals/add-aggregate-score.png"
  alt="Add aggregate score"
  width={1136 / 2}
  height={1012 / 2}
/>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/bar-score-comparison-poster.png"
>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/group-by-dataset-poster.png"
>
...
<video
  ...
  autoPlay
  muted
  poster="/docs/guides/evals/scatterplot-poster.png"
>
