...
- Support for creating and pushing custom Python tools and prompts from your codebase with `braintrust push`. Read the guides to [tools](/docs/core/functions/tools) and [prompts](/docs/core/functions/prompts) for more information.
...
- You can now create server-side online evaluations for your logs. Online evals support both [autoevals](/docs/reference/autoevals) and
  [custom scorers](/docs/core/playground) you define as LLM-as-a-judge, TypeScript, or Python functions. See
...
- Support for [custom models](/docs/core/playground#custom-models) in the playground.
...
- The prompt playground is now live! We're excited to get your feedback as we continue to build
  this feature out. See [the docs](/docs/core/playground) for more information.
...
- Introducing datasets! You can now upload datasets to Braintrust and use them in your experiments. Datasets are
  ...
  performance against a baseline. Learn more about [how to create and use datasets in the docs](/docs/core/datasets).
