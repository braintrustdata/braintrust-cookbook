...
<div className="flex flex-col text-balance">
  <div className="flex md:gap-6 flex-col md:flex-row">
    <div className="flex-1">
      ...
      Rapidly prototype with different prompts<br />and models in the [playground](/docs/core/playground)
    </div>
    <div className="flex-1">
  ...
  <div className="flex md:gap-6 flex-col md:flex-row">
    ...
    <div className="flex-1">
     ### Data management
     [Manage](/docs/core/datasets) and [review](/docs/guides/human-review) data to store and version<br />your test sets centrally
    </div>
  </div>
</div>
