...
Next, create an API key to authenticate your evaluation script. You can create an API key in the [settings page](https://www.braintrust.dev/app/settings?subroute=api-keyss).
