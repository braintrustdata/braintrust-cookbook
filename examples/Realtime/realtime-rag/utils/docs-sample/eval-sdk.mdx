...
- Dig into our [Evals guide](/docs/evaluate/run-evaluations) to learn more about how to run evals.
- Look at our [cookbook](/docs/cookbook) to learn how to evaluate RAG, summarization, text-to-sql, and other popular use cases.
- Learn how to [log traces](/docs/instrument/custom-tracing) to Braintrust.
