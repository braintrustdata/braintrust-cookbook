...
As you scale, Braintrust's [Datasets](/docs/core/datasets) are a great tool for managing your test cases.
...
do that by visiting the [Playground](/docs/core/playground) and creating custom scorers.
