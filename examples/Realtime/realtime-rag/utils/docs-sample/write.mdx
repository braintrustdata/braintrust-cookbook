...
<Callout type="warn">
  ...
  your data is noisy, your AI model is imperfect, and your scoring methods are a
  little bit wrong. The goal of evaluation is to assess each of these components
...
<video
  ...
  src="/docs/guides/logging/Online-Scoring-Setup.mp4"
  loop
  autoPlay
  muted
  poster="/docs/guides/logging/Online-Scoring-Setup-Poster.png"
></video>
