...
- Use a larger or more custom [dataset](/docs/core/datasets)
- Write more complex [structured output](/docs/core/functions/prompts#structured-outputs) JSON schema
