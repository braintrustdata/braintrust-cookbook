# Using hosted tool functions to perform RAG

Retrieval augmented generation (RAG) is a technique for providing answers to questions using information from a vector database. RAG improves the accuracy of LLM responses by providing relevant context.
...
In this cookbook, we'll define an agent that answers questions about the Braintrust documentation.

Along the way, we'll also experience how simple it is to work across Braintrust's UI and your code— the new AI engineering workflow.
