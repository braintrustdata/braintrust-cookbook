...
tags:
  ...
  - logging
  - next.js
image: /images/cookbook-banners/AI-app.png
twimage: /images/cookbook-banners/AI-app.png
---
...
- [Writing more specific evals](/docs/evaluate/run-evaluations) or learning about [different scoring functions](/docs/evaluate/run-evaluations)
...
- Changing how you [log data](/docs/instrument/custom-tracing), including [incorporating user feedback](/docs/instrument/custom-tracing#user-feedback)
