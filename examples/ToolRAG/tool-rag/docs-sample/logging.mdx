...
and collect data into [datasets](/docs/annotate/datasets).

See the [tracing guide](/docs/instrument/custom-tracing) for more details on how to trace your code in Braintrust.

## Why log in Braintrust?

By design, logs are _exactly_ the same data structure as [Experiments](/docs/evaluate/run-evaluations). This leads to a number of useful properties:
...
For full details, refer to the [tracing](/docs/instrument/custom-tracing) guide, which
...
controls](/docs/admin/access-control) at the project level.
