...
In the `tool-ocr` directory, we set up a script for you that will upload a sample dataset of recipe images. To upload the dataset to Braintrust, run:
