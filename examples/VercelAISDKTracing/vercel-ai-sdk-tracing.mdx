...
- A [project](/docs/admin/projects) in Braintrust
...
<Note>
  ...
  clients](/docs/instrument/trace-llm-calls#manual-instrumentation)
...
- [Customize](/docs/instrument/trace-application-logic) and [extend](/docs/instrument/advanced-tracing) traces to better optimize for your use case
