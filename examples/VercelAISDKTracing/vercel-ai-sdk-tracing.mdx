...
<Note>
  ...
  clients](/docs/instrument/custom-tracing#wrapping-llm-clients)
...
- [Customize](/docs/instrument/custom-tracing) and [extend](/docs/instrument/advanced-tracing) traces to better optimize for your use case
