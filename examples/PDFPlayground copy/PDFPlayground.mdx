...
Before setting up the public url method I want to show you how to click on the paperclip attachment and add a file manually.
...
Now that you know that this is an option, let's cover the public url method.
...
## Next Steps
After mastering the process of converting spans with PDF attachments into a dataset and executing the PDFs in the playground, you can:
