...
![The Topics homepage before enabling classification](./assets/topics-homepage.png)
...
![Handwritten notes on failure patterns identified from reading through logs](./assets/manual-notes.jpg)
